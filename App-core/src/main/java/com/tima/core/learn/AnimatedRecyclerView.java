        ...
        return new DefaultItemAnimator() {
            ...
            public void runPendingAnimations() {
                ...
                for (int i = mPendingSettleList.size() - 1; i >=0; i--) {
                    ...
                    ViewCompat.animate(vh.textView) //指定动画执行的View
                            .translationX(0f) //x轴偏移
                            .alpha(1f)//透明度
                            ...
                            new ViewPropertyAnimatorListener() {
                                ...
                                public void onAnimationStart(View view) {
                                    dispatchAnimationStarted(vh);//调用RecycleView的动画执行方法
                                }
                                ...
                                public void onAnimationEnd(View view) {
                                    ...
                                    dispatchAnimationFinished(vh);//调用RecycleView的动画关闭方法
                                }
