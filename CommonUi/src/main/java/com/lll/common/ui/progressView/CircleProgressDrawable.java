...
/**
 * Description: 自定义Drawable，实现圆形进度条效果
 * Version: 1.0
...
public class CircleProgressDrawable extends Drawable {
     ...
     */
    CircleProgressDrawable(int ringWidth, float circleScale, int outlineColor, int ringColor, int centerColor) {
        this.progress = 0;
...
//            canvas.drawArc(arcElements, 89, -progress, false, paint);
    ...
    public static class Builder {
         ...
         */
        public CircleProgressDrawable create() {
            return new CircleProgressDrawable(ringWidth, circleScale, outlineColor, ringColor, centerColor);
        }
