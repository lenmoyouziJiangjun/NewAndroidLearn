...
/**
 * Description: 公共的RecyclerView
 * Version:
 * Created by lll on 2016/5/26.
 * CopyRight lll
 */
public abstract class BaseLayoutManagerActivity<T extends RecyclerView.LayoutManager> extends Activity {


    public T mLayoutManager;

    public RecyclerView mRecyclerView;

    public ConfigToggle[] mConfigToggles;
